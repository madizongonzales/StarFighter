...
ANaveAereaJugador* ASS_Player::GetSS_PlayerPawn() const
{
    return Cast<ANaveAereaJugador>(GetController());
}
...
void ASS_Player::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
    ...
    //PlayerInputComponent->BindAxis(FName("MoveRight1"), this, &ASS_Player::MoveRight_1);
    //PlayerInputComponent->BindAxis(FName("MoveUp1"), this, &ASS_Player::MoveUp_1);
...
void ASS_Player::MoveRight_1(float AxisValue)
{
    Current_X_Velocity = MaxVelocity * AxisValue;
}

void ASS_Player::MoveUp_1(float AxisValue)
{
